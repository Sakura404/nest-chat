...
var jwtModule = jwt_1.JwtModule.registerAsync({
...
var AuthModule = /** @class */ (function () {
    ...
    AuthModule = __decorate([
        common_1.Module({
            imports: [jwtModule, typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, group_entity_1.Group]), passport_1.PassportModule],
            exports: [jwtModule],
            controllers: [auth_controller_1.AuthController],
            providers: [
                auth_service_1.AuthService,
                local_strategy_1.LocalStorage,
